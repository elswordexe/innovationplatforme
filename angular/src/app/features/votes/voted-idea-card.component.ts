...
@Component({
  selector: 'app-voted-idea-card',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './voted-idea-card.component.html',
  styleUrls: ['./voted-idea-card.component.css']
})
export class VotedIdeaCardComponent {
  ...
  onClick(): void {
    this.cardClick.emit(this.idea.id);
  }
